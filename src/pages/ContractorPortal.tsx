...
export function ContractorPortal() {
  ...
  return <div className="flex min-h-full flex-1 overflow-y-auto bg-surface-container-low p-4 pt-6 md:p-10 md:pt-8"><div className="mx-auto w-full max-w-[1400px] space-y-8">
