...
const phaseLabels: Record<string, string> = { autorizacion_inicial: "Autorización inicial", anteproyecto: "Anteproyecto", directorio: "Revisión del Directorio", planos_tecnicos: "Planos técnicos", inicio_obra: "Inicio de obra", obra_activa: "Obra activa", cierre: "Cierre" };
