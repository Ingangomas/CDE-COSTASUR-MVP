...
import { GovernanceRequestComposer } from "../components/GovernanceRequestComposer";
import { ControlProjectActivityPanel } from "../components/ControlProjectActivityPanel";
...
export function ControlDeObrasProjectDetails() {
  const { id } = useParams();
  const [activeTab, setActiveTab] = useState<"expediente" | "agenda" | "planos" | "reportes">("expediente");
